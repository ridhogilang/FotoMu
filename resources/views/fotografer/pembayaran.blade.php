                                ...
                                <div class="col-lg-8">
                                    <div class="tab-content p-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($penarikanItem->rekening_id)
                                                                {{ $penarikanItem->rekening->nama }} -
                                                                {{ $penarikanItem->rekening->nama_bank }}
                                                            @else
                                                                -
                                                            @endif
                                                        </td>
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                @foreach ($semuaTransaksi as $index => $transaksi)
                                                    <tr>
                                                        <td>{{ $index + 1 }}</td>
