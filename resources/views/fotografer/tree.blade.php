...
@push('footer')
    ...
    <script>
        ...
        plantButtonDiv.innerHTML =
            '<a href="/fotografer/tambah-tree" style="background-color: purple; color: white; padding: 10px; border: none; border-radius: 5px;" >+ Tanam FotoTree</a>';
        map.getContainer().appendChild(plantButtonDiv);
    </script>
