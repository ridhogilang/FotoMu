        ...
        <ul class="topbar-menu d-flex align-items-center">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        <h5 class="noti-item-title fw-semibold font-14">Karen Robinson
                                        </h5>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('iconrobot/user/user2.png') }}" alt="user-image" class="rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="{{ route('foto.profil') }}" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
                        <span>Profil</span>
                    </a>

                    <!-- item-->
                    <a href="{{ route('foto.pembayaran') }}" class="dropdown-item notify-item">
                        <i class="fe-dollar-sign"></i>
                        <span>Pembayaran</span>
                    </a>

                    <!-- item-->
                    <a href="{{ route('foto.filemanager') }}" class="dropdown-item notify-item">
                        <i class="fe-folder"></i>
                        <span>File Manager</span>
                    </a>

                    <a href="{{ route('user.produk') }}" class="dropdown-item notify-item">
                        <i class="fe-camera"></i>
                        <span>FotoMu</span>
                    </a>
