    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            @php
                ...
                $isDaftar = \App\Models\DaftarFotografer::where('user_id', Auth::id())->exists();
            @endphp
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3 class="fw-bold mb-3">
                                    Status Pengajuan Fotografer :
                                    <span
                                        class="badge 
                                        @if ($daftar->status == 'Ditinjau') bg-warning 
                                        @elseif ($daftar->status == 'Diterima') bg-success 
                                        @elseif ($daftar->status == 'Ditolak') bg-danger
                                        @else bg-warning @endif">
                                        {{ $daftar->status }}
                                    </span>
                                </h3>
                                <p style="font-size: 16px;">Pengajuan Anda untuk mendaftar sebagai <strong>fotografer di
                                        Aplikasi FotoMu saat ini sedang
                                        dalam tahap peninjauan.</strong> Terima kasih telah meluangkan waktu untuk mengisi
                                    formulir
                                    pendaftaran dan memberikan informasi yang diperlukan. Tim kami saat ini sedang meninjau
                                    data yang Anda kirimkan untuk memastikan semua persyaratan telah terpenuhi. Mohon
                                    menunggu, dan kami akan segera menghubungi Anda melalui email atau notifikasi aplikasi
                                    setelah proses peninjauan selesai. Terima kasih atas kesabaran Anda!</p>
                            </div>
                        </div>
                    </div><!-- end col -->
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('user.upgrade-store') }}" id="demo-form"
                                        ...
                                        <div class="col-lg-12">
                                            <div>
                                                <input type="file" data-plugins="dropify" data-max-file-size="10M"
                                                    name="foto_ktp" accept=".jpg, .jpeg, .png" required="" />
                    ...
                    <div class="col-lg-6">
                        <div class="card" style="background-color: #6658DC; border-radius: 15px; color: white;">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><strong>Peluang Penghasilan Tambahan:</strong> Dapatkan bayaran dari setiap foto
                                        yang
                                    ...
                                    <li><strong>Komunitas Kreatif:</strong> Bergabung dengan komunitas fotografer yang aktif
                                        dan
                                        saling berbagi tips dan trik fotografi.</li>
                                    <li><strong>Fleksibilitas Waktu:</strong> Atur sendiri jadwal pemotretan Anda sesuai
                                        dengan
