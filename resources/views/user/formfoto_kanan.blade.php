                        ...
                        <div class="card text-white bg-danger text-xs-center">
                            <div class="card-body">
                                <blockquote class="card-bodyquote mb-0">
                                    <p>Hadap Kanan dan pastikan wajahmu bersih dan tidak tertutup oleh aksesoris (selain
                                        kacamata)
                                        dan rambut</p>
                                </blockquote>
                            </div>
    ...
    <script>
        ...
        submitBtn.addEventListener('click', () => {
            ...
            canvas.toBlob(blob => {
                ...
                formData.append('file', blob, 'fotokanan.png'); // Nama file yang dikirim ke server

                // Kirim data gambar ke server
                fetch('{{ route('user.fotokanan') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            Swal.fire({
                                title: 'Berhasil!',
                                text: 'Data foto anda sudah kami proses, silahkan cari foto favorit anda dengan mudah!',
                                icon: 'success',
