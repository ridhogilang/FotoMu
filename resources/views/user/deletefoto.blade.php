                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="row align-items-center mt-3">
                                                <button type="button" class="btn btn-success waves-effect waves-light btn-pulihkan" data-foto-id=" {{ $similiar->id }}">Pulihkan</button>
                                            </div>                                            
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Attach a click event listener to the "Pulihkan" button
        document.querySelector('.btn-pulihkan').addEventListener('click', function() {
            var fotoId = $(this).data('foto-id'); // Assuming `foto_id` is passed in data attributes
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                // Optionally reload or update the page here, if needed
